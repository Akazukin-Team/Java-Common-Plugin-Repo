# Common Plugin for Repository

[![Build Status](https://github.com/Akazukin-Team/Java-Common-Plugin-Repo/actions/workflows/build.yml/badge.svg)](https://github.com/Akazukin-Team/Java-Common-Plugin-Repo/actions/workflows/build.yml)

A common plugin for repository management.
...
2. Add the dependency to the `dependencies` block in your `build.gradle` file:
   ```groovy
   implementation 'org.akazukin.plugin:common-repo:<VERSION>'
   ```
...
1. Clone the repository:
   ...
   ```shell
   git clone https://github.com/Akazukin-Team/Java-Common-Plugin-Repo.git
   cd Java-Common-Plugin-Repo
   ```
